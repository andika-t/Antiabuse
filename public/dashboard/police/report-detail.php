...
try {
    ...
    if (!$report) {
        header('Location: ' . BASE_URL . '/dashboard/police/reports.php');
        exit();
    }
...
if (!$report) {
    header('Location: ' . BASE_URL . '/dashboard/admin/reports.php');
    exit();
}
    ...
    <div class="dashboard-container">
        <main class="main-content">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
                ...
                <a href="<?php echo BASE_URL; ?>/dashboard/police/reports.php" class="btn btn-secondary">← Kembali</a>
            </div>
