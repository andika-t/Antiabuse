...
try {
    ...
    if (!$content) {
        header('Location: ' . BASE_URL . '/dashboard/user/index.php?section=education&error=content_not_found');
        exit();
    }
    ...
    <div class="dashboard-container">
        <main class="main-content">
            <div class="content-container">
                <a href="<?php echo BASE_URL; ?>/dashboard/user/index.php?section=education" class="back-link">
