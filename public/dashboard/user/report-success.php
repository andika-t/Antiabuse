...
if (!$report) {
    header('Location: ' . BASE_URL . '/dashboard/user/reports.php');
    exit();
}
    ...
    <div class="success-container">
        <div class="success-card">
            ...
            <div class="success-actions">
                <a href="<?php echo BASE_URL; ?>/dashboard/user/reports.php" class="btn btn-primary">Lihat Daftar Laporan</a>
                <a href="<?php echo BASE_URL; ?>/dashboard/user/create-report.php" class="btn btn-secondary">Buat Laporan Baru</a>
            </div>
        </div>
    </div>
</body>
