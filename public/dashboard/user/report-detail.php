...
<body>
    <div class="detail-container">
        <div class="detail-header">
            ...
            <a href="<?php echo BASE_URL; ?>/dashboard/user/reports.php" class="btn btn-secondary">← Kembali</a>
        </div>
        ...
        <div style="text-align: center; margin-top: 40px;">
            <a href="<?php echo BASE_URL; ?>/dashboard/user/reports.php" class="btn btn-secondary">Kembali ke Daftar Laporan</a>
        </div>
    </div>
</body>
</html>
