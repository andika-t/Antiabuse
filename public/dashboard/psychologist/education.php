...
<body>
    ...
    <script>
        function viewContent(contentId) {
            fetch('<?php echo BASE_URL; ?>/dashboard/psychologist/education-detail-api.php?id=' + contentId)
        ...
        function deleteContent(contentId, contentTitle) {
            ...
            fetch('<?php echo BASE_URL; ?>/dashboard/psychologist/education-delete.php', {
                method: 'POST',
                body: formData
            })
            .then(response => response.json())
