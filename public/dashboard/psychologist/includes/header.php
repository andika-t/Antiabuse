<?php
// Header component for psychologist dashboard
...
<header class="dashboard-header">
    <div class="header-content">
        ...
        <nav class="header-nav">
            ...
            <a href="education.php" class="nav-link <?php echo $currentPage == 'education.php' || $currentPage == 'education-form.php' ? 'active' : ''; ?>" data-nav="1">Edukasi</a>
        </nav>
