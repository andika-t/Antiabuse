...
<header class="dashboard-header">
    <div class="header-content">
        ...
        <nav class="header-nav">
            ...
            <a href="users.php" class="nav-link <?php echo $currentPage == 'users.php' ? 'active' : ''; ?>" data-nav="1">Pengguna</a>
            <a href="reports.php" class="nav-link <?php echo $currentPage == 'reports.php' ? 'active' : ''; ?>" data-nav="2">Laporan</a>
            <a href="panic-button.php" class="nav-link <?php echo $currentPage == 'panic-button.php' ? 'active' : ''; ?>" data-nav="3">Panic</a>
            <a href="forum.php" class="nav-link <?php echo $currentPage == 'forum.php' ? 'active' : ''; ?>" data-nav="4">Forum</a>
            <a href="education.php" class="nav-link <?php echo $currentPage == 'education.php' ? 'active' : ''; ?>" data-nav="5">Edukasi</a>
        </nav>
...
(function() {
    function initNavIndicator() {
        ...
        navLinks.forEach(link => {
            ...
            // Focus animation removed as per request
