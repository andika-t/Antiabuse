...
try {
    ...
    if (!$alert) {
        header('Location: ' . BASE_URL . '/police/index.php?error=alert_not_found');
        exit();
    }
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
        ...
        if ($action === 'respond') {
            ...
            header('Location: ' . BASE_URL . '/police/panic-detail.php?id=' . $alertId . '&success=responded');
            exit();
            ...
            header('Location: ' . BASE_URL . '/police/panic-detail.php?id=' . $alertId . '&success=resolved');
            exit();
        }
    }
        ...
        <main class="main-content">
            <div style="max-width: 900px; margin: 0 auto;">
                <div style="margin-bottom: 30px;">
                    <a href="<?php echo BASE_URL; ?>/police/index.php" style="color: var(--color-primary); text-decoration: none; font-size: 14px;">
