...
<body>
        ...
        <main class="main-content">
                    ...
                    <div class="card-col">
                        ...
                        <div class="dashboard-card">
                            ...
                            <div class="quick-actions-grid">
                                <a href="<?php echo BASE_URL; ?>/user/create-report.php" class="action-card">
            ...
            <div id="section-reports" class="content-section">
                <div class="section-header">
                    ...
                    <a href="<?php echo BASE_URL; ?>/user/create-report.php" class="btn-create">+ Buat Laporan Baru</a>
                </div>
                ...
                <?php if (empty($reports)): ?>
                    <div class="empty-state">
                        ...
                        <a href="<?php echo BASE_URL; ?>/user/create-report.php" class="btn-create">Buat Laporan Pertama</a>
                    </div>
                <?php else: ?>
                    <div class="reports-list">
                        <?php foreach ($reports as $report): ?>
                            <a href="<?php echo BASE_URL; ?>/user/report-detail.php?id=<?php echo $report['id']; ?>" class="report-card">
    ...
    function sendPanicAlert(latitude, longitude) {
        ...
        fetch('<?php echo BASE_URL; ?>/user/panic-handler.php', {
            method: 'POST',
            body: formData
        })
    ...
    window.filterEducation = function(category) {
        ...
        window.location.href = currentUrl.toString();
            ...
            window.viewEducationContent = function(contentId) {
                window.location.href = '<?php echo BASE_URL; ?>/user/education-detail.php?id=' + contentId;
            };
            ...
            window.openEducationModal = function(contentId) {
                ...
                // Fetch content data
                fetch('<?php echo BASE_URL; ?>/user/education-detail-api.php?id=' + contentId)
                    .then(response => response.json())
                    .then(data => {
                        if (data.success) {
            ...
            window.createPost = function(event) {
                ...
                const apiUrl = '<?php echo BASE_URL; ?>/user/forum-action.php';
            ...
            function loadComments(postId) {
                ...
                fetch('<?php echo BASE_URL; ?>/user/forum-action.php?action=get_comments&post_id=' + postId)
                    .then(response => response.json())
                    .then(data => {
                        if (data.success) {
            ...
            window.submitComment = function(event, postId) {
                ...
                fetch('<?php echo BASE_URL; ?>/user/forum-action.php', {
                    method: 'POST',
                    body: formData
                })
                .then(response => response.json())
