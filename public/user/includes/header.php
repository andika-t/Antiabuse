...
<header class="dashboard-header">
    <div class="header-content">
        ...
        <nav class="header-nav">
            ...
            <a href="#" class="nav-link" data-section="reports">Daftar Laporan</a>
            <a href="#" class="nav-link" data-section="panic">Panic</a>
            <a href="#" class="nav-link" data-section="forum">Forum</a>
            <a href="#" class="nav-link" data-section="education">Edukasi</a>
        </nav>
...
<script>
// Sliding Navigation Indicator with Hover Animation
(function() {
    function initNavIndicator() {
        ...
        // Update on hover - animasi garis bergerak
        ...
        // Expose updateIndicator function globally for SPA navigation
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', function() {
            setTimeout(initNavIndicator, 50);
        });
    } else {
        setTimeout(initNavIndicator, 50);
    }
